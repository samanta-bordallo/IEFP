...
class Program
{
    ...
    static void ListUfcds()
    {
        ...
        Console.WriteLine("Do you want to return to the UFCD menu? (yes/no)");
        string returnToUfcdMenu = Console.ReadLine();
        if (returnToUfcdMenu.ToLower() == "yes")
            UfcdMenu();
    }
    ...
    static void EnrollStudent()
    {
        ...
        Console.WriteLine("Do you want to return to the 'Manage Students' menu? (yes/no)");
        string returnToManageStudentsMenu = Console.ReadLine();
        if (returnToManageStudentsMenu.ToLower() == "yes")
            ManageStudents();
    }
    ...
    static void EnrollProfessor()
    {
        ...
        Console.WriteLine("Do you want to return to the 'Manage Professors' menu? (yes/no)");
        string returnToManageProfessorsMenu = Console.ReadLine();
        if (returnToManageProfessorsMenu.ToLower() == "yes")
            ManageProfessors();
    }
    ...
    static void AddStudentsToClass()
    {
        ...
        Console.WriteLine("Do you want to return to the Classes menu? (yes/no)");
        string returnToClassesMenu = Console.ReadLine();
        if (returnToClassesMenu.ToLower() == "yes")
            ClassesMenu();
    }
...

    {
        ...
        Console.WriteLine("Do you want to return to the 'Manage Classes' menu? (yes/no)");
        string returnToClassesMenu = Console.ReadLine();
        if (returnToClassesMenu.ToLower() == "yes")
            ClassesMenu();
    }
